    ...
    def __init__(self, master=None):
        ...
        self.algorithmbox.configure(cursor="hand2", state="readonly",
                                    values=('BFS', 'DFS (Graph Search)', 'DFS (Backtracking)', 'Voraz (Manhattan)',
                                            'ID', 'A* Manhattan', 'A* Euclidean', 'IDA* Manhattan', 'MyMethod1', 'MyMethod2', 'MyMethod3'))
    ...
    def computeHCost(self, event=None):
        ...
        if not initialState or not currentState:
            ...
            if algo in ['A* Manhattan', 'Voraz (Manhattan)', 'IDA* Manhattan']:
                ...
                result = f'MyMethod1 heuristic: {main.myMethod1(currentState)}'
            elif algo == 'MyMethod2':
                result = f'MyMethod2 heuristic: {main.myMethod2(currentState)}'
            elif algo == 'MyMethod3':
                result = f'MyMethod3 heuristic: {main.myMethod3(currentState)}'
            else:
